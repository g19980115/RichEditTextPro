package com.xhs.richparser.base;
...
public abstract class AbstractRichParser implements IRichParser4Local, IRichParser4Server, IRichParserAdapter {
    ...
    protected abstract int getDrawableId(Pair<String, String> info);
    ...
    protected Drawable getDrawable(Context context, int drawableId) {
